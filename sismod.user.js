...
function fixExpandedSearch() {
    var expand = document.getElementsByName("DERIVED_CLSRCH_SSR_EXPAND_COLLAPS");
    expand.click();
/*
    var advancedSearch = document.getElementsByClassName("SSSHYPERLINKBOLD");
    var clickHandler = advancedSearch[0];

    var divs = document.getElementsByTagName("a");
    //divs now contain each and every div element on the page
    var selectionDiv = document.getElementById("DERIVED_CLSRCH_SSR_EXPAND_COLLAPS$81$");
