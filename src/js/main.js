...
*/
    ...
    var majorNames = new Array("ACCOUNTING", "MANAGEMENT", "ECONOMICS (COB)", "FINANCE", "MARKETING", "DECISION SCIENCES", "BUSINESS LEGAL STUDIES", "MANAGEMENT INFORMATION SYSTEMS", "INTERNATIONAL BUSINESS", "CONSUMER FINANCE", "ELECTRICAL ENGINEERING", "GENERAL ENGINEERING", "INDUSTRIAL & SYSTEMS ENGINEERING", "MECHANICAL ENGINEERING", "MICROELECTRONIC ENGINEERING", "COMPUTER ENGINEERING", "QUALITY & APPLIED STATISTICS", "MICROSYSTEMS ENGINEERING", "CHEMICAL ENGINEERING", "BIOMEDICAL ENGINEERING", "LIBERAL ARTS/DEGREE AUDIT", "CRIMINAL JUSTICE", "ENGLISH", "ENGLISH", "FINE ARTS", "HUMANITIES", "HISTORY", "SCIENCE, TECHNOLOGY & SOCIETY", "PHILOSOPHY", "ANTHROPOLOGY", "ECONOMICS", "SOCIAL SCIENCE", "POLITICAL SCIENCE", "PSYCHOLOGY", "SOCIOLOGY", "GENERAL STUDIES, GENERAL", "INTERDISCIPLINARY-AEROSPACE", "INTERDISCIPLINARY-LIBERAL ARTS", "PUBLIC POLICY", "WOMEN'S & GENDER STUDIES", "INTERNATIONAL AND GLOBAL STUDIES INTERNATIONAL STUDIES", "Modern Language-Arabic", "Modern Language-American Sign Language", "Modern Language-Chinese", "Modern Language-French", "Modern Language-German", "Modern Language-Italian", "Modern Language-Japanese", "Modern Language-Protuguese", "Modern Language-Russian", "Modern Language-Spanish", "FOREIGN LANGUAGES", "URBAN AND COMMUNITY STUDIES", "SCHOOL PSYCHOLOGY", "MATERIAL CULTURE SCIENCES", "CULTURAL RESOURCE STUDIES", "COMMUNICATION", "HONORS LIBERAL ARTS", "ENGINEERING TECHNOLOGY", "PACKAGING SCIENCE", "CIVIL ENGINEERING TECHNOLOGY", "ELECTRICAL ENGINEERING TECH", "MECHANICAL ENGINEERING TECH", "TELECOMMUNICATIONS ENGINEERING TECH", "MANUFACTURING ENGINEERING TECH", "COMPUTER ENGINEERING TECHNOLOGY", "HOSPITALITY SERVICE", "NUTRITION MANAGEMENT", "FOOD MANAGEMENT", "HOTEL & RESORT MANAGEMENT", "TRAVEL & TOURISM MANAGEMENT", "HOSPITALITY - TOURISM", "SERVICE QUALITY MANAGEMENT", "HUMAN RESOURCE DEVELOPMENT", "INSTRUCTIONAL TECHNOLOGY", "ENVIRONMENTAL SUSTAINABILITY, HEALTH AND SAFETY MGMT", "FACILITY MANAGEMENT", "SAFETY TECHNOLOGY", "DISASTER & EMERGENCY MANAGEMENT", "HEALTH SYSTEMS ADMINISTRATION", "RESERVE OFFICER TRAINING - ARMY", "AEROSPACE STUDIES", "ELECTRICAL MECHANICAL ENGINEERING TECHNOLOGY", "ACCOUNTING & BUSINESS SYSTEMS (CAST)", "BUSINESS ADMIN-MGMT (CAST)", "QUALITY MANAGEMENT", "GLOBAL SOURCING", "TECH COMMUNICATIONS", "MATH & SCIENCE", "GEOGRAPHIC TECHNOLOGY", "SECURITY TECHNOLOGY", "IMDB MULTI/INTERDISCIPLINARY STUDIES", "PROFESSIONAL STUDIES", "ACCOUNTING TECHNOLOGY", "ADMINISTRATIVE SUPPORT TECHNOLOGY", "GENERAL BUSINESS", "NETWORKING AND CYBER SECURITY CONCENTRATION COURSES", "COMPUTER TECH SUPPORT CONCENTRATION COURSES", "GENERAL COMPUTING COURSES", "CAREER DEVELOPMENT", "CIMT - COMPUTER INTEGRATED MACH TECH", "SUMMER VESTIBULE EXPERIENCE", "MASTER'S OF SCIENCE IN SECONDARY EDUCATION", "CAREER DEVELOPMENT", "GENERAL ARTS AND IMAGING COURSES", "GRAPHIC DESIGN CONCENTRATION COURSES", "GRAPHIC PRODUCTION CONCENTRATION COURSES", "ASL-ENGLISH INTERPRETATION", "LABORATORY SCIENCE TECHNOLOGY", "COMMUNICATIONS STUDIES", "HUMANITIES & SOCIAL SCIENCES", "HUMANITIES & SOCIAL SCIENCES", "HUMANITIES & SOCIAL SCIENCES", "ENGLISH", "MATHEMATICS", "SCIENCE", "AMERICAN SIGN LANGUAGE", "CAREER DEVELOPMENT", "COMPUTER AIDED DRAFTING TECHNOLOGY", "AUTOMATION TECHNOLOGIES", "BIOLOGY", "BIOLOGY NON-MAJORS", "BIOLOGY NON-MAJORS", "ENVIRONMENTAL SCIENCE", "ANALYTICAL CHEMISTRY", "BIO CHEMISTRY", "CHEMISTRY", "GENERAL CHEMISTRY", "INORGANIC CHEMISTRY", "ORGANIC CHEMISTRY", "PHYSICAL CHEMISTRY", "ENVIRONMENTAL CHEMISTRY", "MATHEMATICS", "STATISTICS", "PHYSICS", "GENERAL SCIENCE EXPLORATION", "COMPUTATIONAL MATH", "CLINICAL CHEMISTRY", "MEDICAL SCIENCES", "MATERIALS SCI. & ENGINEERING", "POLYMER CHEMISTRY", "DIAGNOSTIC MED SONOGRAPHY", "PHYSICIAN ASSISTANT", "PREMED STUDIES", "COLOR SCIENCE", "IMAGING SCIENCE", "HONORS IN SCIENCE AND MATHEMATICS", "ASTROPHYSICAL SCIENCES AND TECHNOLOGY", "CENTER FOR BIOLOGICAL EDUCATION & TRAINING", "INTERDISCIPLINARY SCIENCE", "PHYS ED VARSITY", "CLUB SPORTS", "HEALTH AND WELLNESS SEMINARS", "DANCE", "FITNESS", "HEALTH AND SAFETY", "LIFETIME REC ACTIVITIES", "INTERACTIVE ADVENTURES", "MARTIAL ARTS", "MILITARY SCIENCES", "FACULTY/STAFF WELLNESS", "ENGLISH LANGUAGE CENTER", "COLLEGE RESTORATION", "ACADEMIC SUPPORT CENTER", "FIRST-YEAR ENRICHMENT", "INTERDISCIPLINARY IMAGING ARTS", "NEW MEDIA DESIGN", "GRAPHIC DESIGN", "ART EDUCATION", "ART & DESIGN EXTENDED STUDIES", "FOUNDATION COURSES", "COMPUTER GRAPHICS DESIGN", "INTERIOR DESIGN", "ILLUSTRATION", "MEDICAL ILLUSTRATION", "FINE ARTS STUDIO", "INDUSTRIAL DESIGN", "ART DESIGN GRADUATE STUDIES", "ART HISTORY", "CERAMICS & CERAMIC SCULPTURE", "GLASS", "METALCRAFTS & JEWELRY", "WEAVING AND TEXTILE DESIGN", "WOODWORKING & FURNITURE DESIGN", "GENERAL CRAFT STUDIES", "CRAFTS EXTENDED STUDIES", "FINE ART PHOTO", "BIOMEDICAL PHOTO", "FILM/VIDEO/ANIMATION", "GRADUATE PHOTOGRAPHY", "PHOTOGRAPHIC ARTS", "IMAGING SYSTEMS MANAGEMENT", "IMAGING & PHOTOGRAPHIC TECHNOLOGY", "PRINTING MANAGEMENT", "PRINTING TECHNOLOGY", "GRAPHIC MEDIA PUBLISHING", "NEW MEDIA PUBLISHING", "UNIVERSITY STUDIES", "COMPUTER PROGRAMMING", "INFORMATION SCIENCES & TECHNOLOGIES", "COMPUTER SCIENCE", "INFORMATION SCIENCES & TECHNOLOGIES  INFO TECH GRAD WEB & MULTIMEDIA", "GRADUATE COMPUTER SCIENCE", "MEDICAL INFORMATICS", "SOFTWARE ENGINEERING", "SOFTWARE ENGINEERING - GRADUATE", "COMPUTING INTRA-COLLEGE STUDIES", "COMPUTING & INFORMATION SCIENCES - PHD", "NETWORKING, SECURITY & SYSTEMS ADMIN - UGRAD", "NETWORKING, SECURITY & SYSTEMS ADMIN - GRAD", "INTERACTIVE GAMES & MEDIA", "INTERACTIVE GAMES & MEDIA - GRADUATE", "INSTITUTE FOR SUSTAINABILITY");
